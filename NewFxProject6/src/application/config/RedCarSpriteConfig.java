...
public class RedCarSpriteConfig extends CarSkinConfig{
	public static final int IMAGE_WIDTH = 43;//done
    public static final int FRONT_BLINKER_ANGLE_DIFF = 19;
    public static final int REAR_BLINKER_ANGLE_DIFF = 154;
    public static final int FRONT_BLINKER_DISTANCE = 45;
    public static final int REAR_BLINKER_DISTANCE = 29;
    
    public static final int FRONT_CORNER_ANGLE_DIFF = 19;
    public static final int REAR_CORNER_ANGLE_DIFF = 154;
