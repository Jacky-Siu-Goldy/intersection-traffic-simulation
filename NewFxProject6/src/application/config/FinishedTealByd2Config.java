...
public class FinishedTealByd2Config extends CarSkinConfig{
	public static final int IMAGE_WIDTH = 35;//done
    public static final int FRONT_BLINKER_ANGLE_DIFF = 19;
    public static final int REAR_BLINKER_ANGLE_DIFF = 149;
