...
public class FinishedBlueBydConfig extends CarSkinConfig {
	
	public static final int IMAGE_WIDTH = 38;
    public static final int FRONT_BLINKER_ANGLE_DIFF = 18;
    public static final int REAR_BLINKER_ANGLE_DIFF = 150;
    public static final int FRONT_BLINKER_DISTANCE = 48;
