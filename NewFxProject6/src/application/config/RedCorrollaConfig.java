...
public class RedCorrollaConfig extends CarSkinConfig {
	
	
	public static final int IMAGE_WIDTH = 38;
    public static final int FRONT_BLINKER_ANGLE_DIFF = 20;
    public static final int REAR_BLINKER_ANGLE_DIFF = 151;
    public static final int FRONT_BLINKER_DISTANCE = 44;
    public static final int REAR_BLINKER_DISTANCE = 26;
    
    public static final int FRONT_CORNER_ANGLE_DIFF = 18;
    public static final int REAR_CORNER_ANGLE_DIFF = 150;
    public static final int FRONT_CORNER_DISTANCE = 50;
    public static final int REAR_CORNER_DISTANCE = 26;
