...
public class FinishedGrey2BydConfig extends CarSkinConfig{


	public static final int IMAGE_WIDTH = 36;//done
    ...
    public static final int REAR_BLINKER_DISTANCE = 25;
