...
public class BlueRaceCarConfig extends CarSkinConfig {
	 	public static final int IMAGE_WIDTH = 36;
	    public static final int FRONT_BLINKER_ANGLE_DIFF = 22;
	    public static final int REAR_BLINKER_ANGLE_DIFF = 148;
	    public static final int FRONT_BLINKER_DISTANCE = 45;
	    public static final int REAR_BLINKER_DISTANCE = 22;
	    
	    public static final int FRONT_CORNER_ANGLE_DIFF = 19;
	    public static final int REAR_CORNER_ANGLE_DIFF = 148;
	    public static final int FRONT_CORNER_DISTANCE = 51;
	    public static final int REAR_CORNER_DISTANCE = 22;
